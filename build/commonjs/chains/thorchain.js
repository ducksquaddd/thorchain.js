...
var ThorChain = /** @class */ (function () {
    function ThorChain(_a) {
        var _b = _a.network, network = _b === void 0 ? xchain_client_1.Network.Mainnet : _b, phrase = _a.phrase, chainIds = _a.chainIds;
        this.chain = xchain_util_1.THORChain;
        this.client = new xchain_thorchain_1.Client({
            network: network,
            phrase: phrase,
            chainIds: chainIds,
        });
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.transfer({
                                ...
                                recipient: receiver,
                                memo: memo,
                                asset: xchain_util_1.AssetRuneNative,
                                walletIndex: 0,
                            })];
